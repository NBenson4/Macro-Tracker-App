...
export default function App() {
  ...
  const [usdaSearch, setUsdaSearch] =
    useState('');

  const [usdaResults, setUsdaResults] =
    useState([]);

  const [usdaLoading, setUsdaLoading] =
    useState(false);

  const [usdaError, setUsdaError] =
    useState('');
  ...
  const filteredFoods = starterFoods.filter(
    (food) =>
      food.name
        .toLowerCase()
    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      >
        ...
        <View style={styles.card}>
          ...
          <View
            style={
              styles.usdaSearchRow
            }
          >
            <TextInput
              style={
                styles.usdaSearchInput
              }
